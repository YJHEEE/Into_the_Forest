    ...
    <div class="container">
      <div class="row">
        <div class="d-flex justify-content-center align-items-center">
          <h1 class="hero-heading mb-1">자주 묻는 질문</h1>
        </div>
        <ol class="breadcrumb ps-0 fs-5 justify-content-center my-5">
          <li class="mx-5 fw-bold active border-bottom border-dark pb-1">FAQ</li>
      ...
      <div class="table mb-4">
        <form action="${path}/community/communityQandAFandA" method="get">
      ...
      <nav aria-label="Page navigation example">
			<ul
				...
				<li class="page-item"><a class="page-link" href="${path}/community/communityQandAFandA?page=${pageInfo.prvePage}"> <i
					...
					<c:forEach begin="${ pageInfo.startPage }" end="${ pageInfo.endPage }" step="1" varStatus="status">
						...
						<c:if test="${ pageInfo.currentPage != status.current}">
							<button class="page-link" onclick="location.href='${ path }/community/communityQandAFandA?page=${ status.current }'">
								<c:out value="${ status.current }"/>
							</button>
						</c:if>
					</c:forEach>
				<li class="page-item"><a class="page-link" href="${ path }/community/communityQandAFandA?page=${ pageInfo.nextPage }"> <i
